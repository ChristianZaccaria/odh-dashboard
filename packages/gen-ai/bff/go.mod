...
// Replace the original llama-stack-k8s-operator with your local development version
...
replace github.com/llamastack/llama-stack-k8s-operator => /Users/czaccari/Documents/GitHubUpstream/llama-stack-k8s-operator
